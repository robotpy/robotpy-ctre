...
libraries = None
cmdclass = {}
# Detect raspberrypi or roboRIO.. not foolproof, but good enough
if exists("/etc/natinst/share/scs_imagemetadata.ini") or _travis_build or ctre_rpi:
    ...
    ext_modules = [
        Extension(
            ...
            libraries=libraries,
            library_dirs=[
                join(get.halsrc, "linux", architecture, "shared"),
                join(get.ctresrc, "linux", architecture, "static"),
            ],
            language="c++",
        )
    ]
